...
public class DaemonService extends Service {
    ...
    private static final int NOTIFY_ID = ChiyuanVACore.getHostPkg().hashCode();
    private static final String CHANNEL_ID = "chiyuanva_daemon_channel";
    private static final String CHANNEL_NAME = "ChiyuanVA Daemon Service";
    private static final String CHANNEL_DESCRIPTION = "Keeps ChiyuanVA core services running";
    ...
    private Notification createNotification() {
        try {
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("ChiyuanVA Core")
