...
import com.chiyuan.va.core.system.BProcessManagerService;
import com.chiyuan.va.core.system.ProcessRecord;
import com.chiyuan.va.core.system.pm.BPackageManagerService;
import com.chiyuan.va.core.system.pm.PackageManagerCompat;
...
public class ActivityStack {
    ...
    public ActivityStack() {
        mAms = (ActivityManager) ChiyuanVACore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    }
    ...
    private int startActivityInNewTaskLocked(int userId, Intent intent, ActivityInfo
        ...
        ChiyuanVACore.getContext().startActivity(shadow);
        return 0;
    }
    ...
    private int realStartActivityLocked(IInterface appThread, Intent intent, String resolvedType,
        ...
        try {
            ...
            BRIActivityManager.get(BRActivityManagerNative.get().getDefault()).startActivity(appThread, ChiyuanVACore.getHostPkg(), intent,
    ...
    private Intent getStartStubActivityIntentInner(Intent intent, int vpid,
        ...
        try {
            Resources resources = PackageManagerCompat.getResources(ChiyuanVACore.getContext(), activityInfo.applicationInfo);
            int id;
            ...
            if (windowIsTranslucent) {
                shadow.setComponent(new ComponentName(ChiyuanVACore.getHostPkg(), ProxyManifest.TransparentProxyActivity(vpid)));
            } else {
                shadow.setComponent(new ComponentName(ChiyuanVACore.getHostPkg(), ProxyManifest.getProxyActivity(vpid)));
            }
