package com.chiyuan.va.core.env;
...
public class BEnvironment {
    private static final File sVirtualRoot = new File(ChiyuanVACore.getContext().getCacheDir().getParent(), ".vcore");
    private static final File sExternalVirtualRoot = ChiyuanVACore.getContext().getExternalFilesDir(".vcore");
    ...
    public static File getXSharedPreferences(String packageName, String prefFileName) {
       return new File(BEnvironment.getDataDir(packageName, ChiyuanVACore.getUserId()), "shared_prefs/" + prefFileName + ".xml");
    }
}
