...
import com.chiyuan.va.entity.am.RunningAppProcessInfo;
import com.chiyuan.va.entity.am.RunningServiceInfo;
import com.chiyuan.va.fake.delegate.ContentProviderDelegate;
import com.chiyuan.va.fake.delegate.InnerReceiverDelegate;
import com.chiyuan.va.fake.delegate.ServiceConnectionDelegate;
...
import com.chiyuan.va.fake.service.base.PkgMethodProxy;
import com.chiyuan.va.fake.service.context.providers.ContentProviderStub;
...
public class IActivityManagerProxy extends ClassInvocationStub {
    ...
    public static class GetContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (auth instanceof String) {
                ...
                if (BuildCompat.isQ()) {
                    args[1] = ChiyuanVACore.getHostPkg();
                }
                ...
                if (auth.equals("settings")
                    ...
                    ProviderInfo providerInfo = ChiyuanVACore.getBPackageManager()
    ...
    public static class StartService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = ChiyuanVACore.getBPackageManager().resolveService(intent, 0, resolvedType, BActivityThread.getUserId());
            if (resolveInfo == null) {
                return method.invoke(who, args);
            }
            ...
            return ChiyuanVACore.getBActivityManager().startService(intent, resolvedType, requireForeground, BActivityThread.getUserId());
        }
    ...
    public static class StopService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                return ChiyuanVACore.getBActivityManager().stopService(intent, resolvedType, BActivityThread.getUserId());
            } catch (SecurityException e) {
    ...
    public static class StopServiceToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                ChiyuanVACore.getBActivityManager().stopServiceToken(componentName, token, BActivityThread.getUserId());
                return true;
            } catch (SecurityException e) {
    ...
    public static Object BindServiceCommon(Object who, Method method, Object[] args,int callingPackageIndex) throws Throwable {
        try {
            ...
            ResolveInfo resolveInfo = ChiyuanVACore.getBPackageManager().resolveService(intent, 0, resolvedType, userId);
            if (resolveInfo != null || AppSystemEnv.isOpenPackage(intent.getComponent())) {
                Intent proxyIntent = ChiyuanVACore.getBActivityManager().bindService(intent,
                ...
                if (proxyIntent != null && proxyIntent.getComponent() != null && 
                    proxyIntent.getComponent().getPackageName().equals(ChiyuanVACore.getHostPkg())){
                ...
                args[callingPackageIndex] = ChiyuanVACore.getHostPkg();
    ...
    public static class BindService extends MethodHook {
        ...
        protected boolean isEnable() {
            return ChiyuanVACore.get().isBlackProcess() || ChiyuanVACore.get().isServerProcess();
        }
    }
    ...
    public static class UnbindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ChiyuanVACore.getBActivityManager().unbindService(iServiceConnection.asBinder(), BActivityThread.getUserId());
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            for (int i = 0; i < intents.length; i++) {
                ...
                switch (type) {
                    case ActivityManagerCompat.INTENT_SENDER_ACTIVITY:
                        ...
                        shadow.setComponent(new ComponentName(ChiyuanVACore.getHostPkg(), ProxyManifest.getProxyPendingActivity(BActivityThread.getAppPid())));
            ...
            if (invoke != null) {
                ...
                if (packagesForUid.length < 1) {
                    packagesForUid = new String[]{ChiyuanVACore.getHostPkg()};
                }
                ChiyuanVACore.getBActivityManager().getIntentSender(invoke.asBinder(), packagesForUid[0], BActivityThread.getCallingBUid());
            }
            return invoke;
        }
    ...
    public static class getPackageForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return ChiyuanVACore.getBActivityManager().getPackageForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class getUidForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            IInterface invoke = (IInterface) args[0];
            return ChiyuanVACore.getBActivityManager().getUidForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class BroadcastIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = ChiyuanVACore.getBActivityManager().sendBroadcast(intent, resolvedType, BActivityThread.getUserId());
            if (proxyIntent != null) {
    ...
    public static class PeekService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            IBinder peek = ChiyuanVACore.getBActivityManager().peekService(intent, resolvedType, BActivityThread.getUserId());
            return peek;
        }
    }
    ...
    public static class getCurrentUser extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Object vaUser = BRUserInfo.get()._new(BActivityThread.getUserId(), "Owner", BRUserInfo.get().FLAG_PRIMARY());
            return vaUser;
        }
    }
