...
public class ProxyVpnService extends VpnService {
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                CHANNEL_ID,
                "ChiyuanVA VPN Service",
                NotificationManager.IMPORTANCE_LOW
            );
            channel.setDescription("VPN service for ChiyuanVA network access");
    ...
    private Notification createNotification() {
        ...
        return builder
            .setContentTitle("ChiyuanVA VPN Active")
    ...
    protected void establishVpn() {
        ...
        try {
            ...
            builder.setSession("ChiyuanVA VPN");
            ...
            builder.setSession("ChiyuanVA Internet Access");
